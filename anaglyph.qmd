---
title: "Anaglyph Gallery"
page-layout: full
---

{{< include _content/gallery-intros/anaglyph.md >}}

::: {.gallery-shell}
<div id="photo-grid" class="photo-grid" aria-label="Anaglyph photo gallery"></div>
...
(activeCategory?.images ?? []).forEach((imageData) => {
  ...
  button.setAttribute("aria-label", imageData.title || "Open image in Anaglyph");
