...
{{< include _content/gallery-intros/animals.md >}}

::: {.gallery-shell}
<div id="photo-grid" class="photo-grid" aria-label="Animals photo gallery"></div>
...
(activeCategory?.images ?? []).forEach((imageData) => {
  ...
  button.setAttribute("aria-label", imageData.title || "Open image in Animals");
