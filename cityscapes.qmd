---
title: "Cityscapes Gallery"
page-layout: full
---

{{< include _content/gallery-intros/cityscapes.md >}}

::: {.gallery-shell}
<div id="photo-grid" class="photo-grid" aria-label="Cityscapes photo gallery"></div>
...
(activeCategory?.images ?? []).forEach((imageData) => {
  ...
  button.setAttribute("aria-label", imageData.title || "Open image in Cityscapes");
