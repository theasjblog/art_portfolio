---
title: "Others Drawings"
page-layout: full
---

{{< include _content/gallery-intros/others.md >}}

::: {.gallery-shell}
<div id="photo-grid" class="photo-grid" aria-label="Others drawing gallery"></div>
...
(activeCategory?.images ?? []).forEach((imageData) => {
  ...
  button.setAttribute("aria-label", imageData.title || "Open image in Others");
