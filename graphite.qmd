...
{{< include _content/gallery-intros/graphite.md >}}

::: {.gallery-shell}
<div id="photo-grid" class="photo-grid" aria-label="Graphite drawing gallery"></div>
...
(activeCategory?.images ?? []).forEach((imageData) => {
  ...
  button.setAttribute("aria-label", imageData.title || "Open image in Graphite");
