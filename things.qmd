...
{{< include _content/gallery-intros/things.md >}}

::: {.gallery-shell}
<div id="photo-grid" class="photo-grid" aria-label="Things photo gallery"></div>
...
(activeCategory?.images ?? []).forEach((imageData) => {
  ...
  button.setAttribute("aria-label", imageData.title || "Open image in Things");
